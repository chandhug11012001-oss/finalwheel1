  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "primary-gradient text-primary-foreground hover:shadow-hero transition-bounce font-semibold",
        heroOutline: "border-2 border-primary/20 bg-background/10 text-primary-foreground hover:bg-primary/10 backdrop-blur-sm transition-smooth",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 transition-smooth",
        comfort: "bg-comfort text-white hover:bg-comfort/90 shadow-soft transition-smooth",
      },
      size: {
